  ...
  const principles = [
    {
      ...
      description: "Your audience, your data, your revenue streams. Code ensures you own it all—forever.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        { text: "ENCODED", highlight: true },
        { text: " LEGACY", highlight: false },
      ],
      description: "Smart contracts automate royalty splits, vesting schedules, and wealth management. Get paid instantly and perpetually.",
      align: "right",
    },
    {
      number: "03",
      ...
      description: "Onchain proof of engagement replaces vanity metrics. Brands get real data, you get real partnerships.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "COLLECTIVE ", highlight: false },
        { text: "STRENGTH", highlight: true },
      ],
      description: "When one sovereign rises, the network benefits. Mutualized success creates anti-fragile prosperity.",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">THE SOVEREIGN SHIFT</h2>
      </div>
